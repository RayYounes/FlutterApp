...
class Level2b extends StatefulWidget {
  const Level2b({Key? key}) : super(key: key);

  @override
  _Level2bState createState() => _Level2bState();
}

class _Level2bState extends State<Level2b> {
  int count = 0;
          ...
          children: [
            ...
            Stack(
              children: [
                // Larger image
                Image.asset(
                  'assets/images/level2b.png', // Path to your larger image
                ...
                if (square1Visible)
                  Positioned(
                    top: 220, // Adjust the position from bottom
                    right: 23, // Adjust the position from right
                ...
                if (square2Visible)
                  Positioned(
                    bottom: 220, // Adjust the position from bottom
            ...
            Center(
              child: Row(
                ...
                children: [
                  Image.asset(
                    'assets/images/level2bobject1.png', // Path to your first image
                    width: 100, // Adjust the width as needed
                    height: 100, // Adjust the height as needed
                  ),
                  SizedBox(width: 10), // Adjust the space between the images
                  Image.asset(
                    'assets/images/level2bobject2.png', // Path to your second image
                    width: 100, // Adjust the width as needed
                    height: 100, // Adjust the height as needed
                  ),
                ],
